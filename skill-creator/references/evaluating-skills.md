...
<Tip>
  Many agent clients report token usage and duration in their task completion responses. Save these values immediately — they aren't persisted anywhere else.
</Tip>
